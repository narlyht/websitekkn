...
<head>
    ...
    <title>Berita & Kegiatan - UMKM CIKOKOL</title>
    <meta name="description" content="Kumpulan Berita & Kegiatan Pengabdian Masyarakat Tim KKN Pemuda Wangsakara Universitas Yatsi Madani di Kelurahan Cikokol."/>
...
<body class="bg-classic-cream text-classic-charcoal font-sans-body antialiased overflow-x-hidden pb-20 md:pb-0">
    ...
    <header class="fixed top-0 w-full z-50 bg-classic-cream/95 backdrop-blur-md shadow-sm border-b border-classic-border transition-all duration-300">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-classic-cream border-b border-classic-border px-6 py-4 flex flex-col gap-3 shadow-lg">
            ...
            <a class="text-sm font-bold text-classic-green py-2 border-l-4 border-classic-gold pl-2" href="{{ route('news.index') }}">Berita</a>
        ...
        <section class="py-20 bg-classic-green text-classic-cream border-b border-classic-gold/30">
            <div class="max-w-7xl mx-auto px-6 md:px-12 text-center">
                <span class="inline-flex items-center gap-2 bg-classic-dark/80 border border-classic-gold/50 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest text-classic-gold-light mb-4 shadow-md">
                    ...
                    Kabar Pengabdian 2026
                </span>
                <h1 class="font-classic text-4xl md:text-5xl font-bold mb-4 text-classic-cream">Berita Kegiatan KKN Wangsakara</h1>
                <p class="text-base text-classic-cream/80 max-w-2xl mx-auto font-light leading-relaxed">
                    Informasi terkini kegiatan pengabdian masyarakat Tim KKN Pemuda Wangsakara Universitas Yatsi Madani di Kelurahan Cikokol.
                </p>
            </div>
        </section>
        ...
        <section class="py-20 bg-classic-cream">
            <div class="max-w-7xl mx-auto px-6 md:px-12">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <a href="{{ route('news.show', ['id' => $n->id]) }}" class="card-hover-effect group bg-white rounded-2xl border border-classic-border overflow-hidden shadow-sm flex flex-col justify-between">
                        <div>
                            ...
                            <div class="p-6">
                                <span class="text-xs text-classic-gold font-bold block mb-2">{{ $n->date }}</span>
                                <h3 class="font-classic text-2xl font-bold text-classic-green mb-3 group-hover:text-classic-gold transition-colors leading-tight line-clamp-2">
                                    {{ $n->title }}
                                </h3>
                                <p class="text-sm text-classic-charcoal/80 line-clamp-3 leading-relaxed font-light">{{ $n->excerpt }}</p>
                            </div>
                        </div>
                        <div class="px-6 pb-6 pt-0">
                            <span class="text-xs font-bold text-classic-green group-hover:text-classic-gold flex items-center gap-1 transition-colors">
                                Baca Selengkapnya <span class="material-symbols-outlined text-sm">arrow_forward</span>
                            </span>
                        </div>
                    </a>
                    @empty
                    <div class="col-span-3 text-center py-12 text-classic-charcoal/60 text-sm">
                        Belum ada berita kegiatan yang diterbitkan.
                    </div>
                    @endforelse
                </div>
            </div>
